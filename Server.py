...
def print_client_sockets(client_sockets):
    # TODO: Replace with "\t".join(client_sockets)
    for c in client_sockets:
        print("\t", c.getpeername())

# TODO: TIME NOW Is a know parameter ( datetime.now )
# TODO: all this can be replaced with datetime.strftime()
...
def main():
    ...
    # TODO: move to Server class and put this in ctor
    ...
    while True:
        ...
        for current_socket in rlist:
            ...
            if current_socket is server_socket:
                ...
                # TODO: magic floaty number ( replace with const or action dictionary )
                ...
                # TODO: Replace Neta with const
                if name == "@Neta" and name not in managers:
                    managers.append("@Neta")

                # TODO: why? this is only used once no reason to cast it to variable
                ...
                if request == "@Neta is a manager now":
                    ...
                    if request == "view-managers":
                        ...
                        if request == "quit":
                            ...
                            # TODO: replace with switch case dictionary
                            # TODO: magic floaty number ( replace with const or action dictionary )
                            if command == "1":
